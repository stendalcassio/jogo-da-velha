...
let declareWinner = (winner) => {
    ...
    const updateLocalStorage = () => {
        localStorage.setItem('scoreboardX', JSON.stringify(scoreboardX.textContent));
        localStorage.setItem('scoreboardY', JSON.stringify(scoreboardY.textContent));
    }
...
buttonReset.addEventListener("click", function(){
    ...
    let scoreboardY = document.querySelector("#score-board-2");
     ...
     localStorage.setItem('scoreboardX', JSON.stringify(scoreboardX.textContent = 0));
     localStorage.setItem('scoreboardY', JSON.stringify(scoreboardY.textContent = 0));
});
